...
import { assignedBrokerCustomers } from "@/lib/staff/operations-v4";
import {
  requireStaff,
  ...
  try {
    ...
    const [
      ...
      (async () => {
        try {
          const assignments =
            await (prisma as any).staffCustomerAssignment.findMany({
              where: {
          ...
          // Never fall back to company-wide customers: an empty list is safer
          // than leaking another staff member's assigned customer records.
          return [];
        }
      })(),
    ...
    const authStatus =
      details === "UNAUTHENTICATED"
        ...
        : details === "FORBIDDEN"
          ? 403
          : details === "STAFF_COMPANY_REQUIRED"
            ? 422
            : 500;
        ...
        message:
          details === "UNAUTHENTICATED"
            ...
            : details === "FORBIDDEN"
              ...
              : details === "STAFF_COMPANY_REQUIRED"
                ? "This Staff account is not assigned to a company."
